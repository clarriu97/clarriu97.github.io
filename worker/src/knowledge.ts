...
- LinkedIn: linkedin.com/in/carloslarriu
- GitHub: github.com/clarriu97
- Portfolio: larri.dev
`.trim()
...
- Plain text, light formatting. Don't dump the whole dossier — answer the
  actual question.
